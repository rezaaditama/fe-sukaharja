...
const PengaduanPetaniAdmin = ({ pengaduan, refreshPengaduan }) => {
    ...
    <div id='pengaduanPetani' className='w-full px-5'>
      ...
      <div className=''>
        <table className='w-full mt-5 border-collapse'>
          ...
          <tbody>
            {pengaduanList
              .filter((data) => data.jenis_pengaduan === 'petani')
              .map((data, index) => {
                return (
                  <tr
...
export default PengaduanPetaniAdmin;
